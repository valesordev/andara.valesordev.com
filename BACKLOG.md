...
|----|--------|-------|------------------------|
| [`AW-SRV-010`](docs/stories/AW-SRV-010-command-ingress-and-log-produce.md) | `review` | Command ingress — parse, authorize, and produce to the command log | review by brian |
...
| [`AW-SRV-010`](docs/stories/AW-SRV-010-command-ingress-and-log-produce.md) | `review` | Command ingress — parse, authorize, and produce to the command log |

...
51 stories — 3 review · 31 ready · 17 done
...
## Implementation lane — server and cli source, tests
  ...
  now    — nothing in flight
  next   AW-SRV-014  ready  Character creation, selection, and binding — a Session…  (unblocks 3)
  ...
  held   13 ready, blocked: AW-SRV-007, AW-CLI-002, AW-CLI-006, AW-SRV-013, AW-SRV-009, AW-SRV-017,…
...
## Decisions the lanes are waiting on
  ...
  AW-SRV-014  What a Character *is* beyond a name and a position. Components on andara.core.Chara…
              9 more, attached to stories neither lane has reached
